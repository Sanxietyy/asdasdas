    ...
    <header class="py-3 border-bottom">
        <div class="container d-flex justify-content-center">
            <a href="#" class="d-flex align-items-center mb-3 mb-lg-0 me-lg-auto link-body-emphasis text-decoration-none">
                <span class="fs-4">Tabel Kategori</span>
            </a>
        </div>
    </header>
    <div class="container">
            ...
            <div class="col-md-4">
                <div class="card mt-2">
                    <div class="card-header">Tambah Kategori</div>
                        <div class="card-body">
                            <form action="../config/aksi_kategori.php" method="POST">
                                <label for="" class="form-label">Nama Kategori</label>
                                <input type="text" class="form-control" name="nama_kategori" required>
                                <button type="submit" name="tambah" class="btn btn-primary mt-2">Tambah Kategori</button>
                            </form>
                        </div>
                </div>
            </div>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button type="submit" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#ubah<?php echo $data['id_kategori'];?>">
                                                    Ubah
                                                </button>

                                                <!-- Modal -->
                                                <div class="modal fade" id="ubah<?php echo $data['id_kategori'];?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <button type="submit" name="edit" class="btn btn-success">Ubah Kategori</button>
                                                                </form>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <button type="submit" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#hapus<?php echo $data['id_kategori'];?>">
                                                    Hapus
                                                </button>
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="../config/aksi_kategori.php" method="POST">
                                                                    <input type="hidden" name="id_kategori" value="<?php echo $data['id_kategori'];?>">
                                                                    Apakah anda yakin ingin menghapus data <strong><?php echo $data['nama_kategori'];?></strong> beserta foto yang ada didalamnya.
