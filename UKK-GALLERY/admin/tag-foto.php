...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <div class="card mt-2">
                    <div class="card-header">Tambah Tag</div>
                        <div class="card-body">
                            <form action="../config/aksi_tag_foto.php" method="POST">
                                ...
                                <select name="id_foto" id="" class="form-control">
                                <?php $result = mysqli_query($con,"SELECT * FROM foto");
                                while ($row = mysqli_fetch_array($result)) { ?>
                                <option class="form-control" value="<?php echo $row['id_foto']; ?>"><?php echo $row['nama_foto']; ?></option>
                                <?php }?>
                            </select>
            ...
            <div class="col-md-8">
                <div class="card mt-2">
                    <div class="card-header">Data Foto Tag</div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    <?php
                                    $i = 1;
                                    $query = mysqli_query($con, "SELECT * FROM foto_tag inner join foto where ");
